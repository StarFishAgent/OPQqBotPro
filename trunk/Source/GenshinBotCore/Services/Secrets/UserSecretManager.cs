...
namespace GenshinBotCore.Services
{
    public class UserSecretManager : ISecretManager
    {
        ...
        public UserSecretManager(GenShinBotContext dbContext,
                                 ...
                                 Action<SecretManagerConfiguration> configuration)
        {
            ...
            secrets = dbContext.Set<UsersSecret>();
            users = dbContext.Set<Users>();
            db = dbContext;
            this.logger = logger;
        }
        ...
        private readonly DbSet<UsersSecret> secrets;
