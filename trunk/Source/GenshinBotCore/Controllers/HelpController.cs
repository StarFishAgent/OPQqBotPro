    ...
    public class HelpController : BotControllerBase
    {
        ...
        private string Help()
        {
            ...
            sb.AppendLine("--------原神查询机器人--------")
              ...
              .AppendLine("6. 骰子")
              .AppendLine("7. 翻译：[翻译 内容]")
              .AppendLine("8. 翻译：[翻译 内容 目标语言]")
              .AppendLine("9. 代谢计算：[代谢计算 性别 体重 身高 年龄]")
              .AppendLine("10. 代谢计算运动：[代谢计算 性别 体重 身高 年龄 运动系数]")
              .AppendLine("11. 代谢计算热量差：[代谢计算 性别 体重 身高 年龄 运动系数]")
              .AppendLine("12. 代谢计算热量摄入：[代谢计算 性别 体重 身高 年龄 运动系数]")
