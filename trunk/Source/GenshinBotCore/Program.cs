...
IHost host = Host.CreateDefaultBuilder(args)
    .ConfigureServices((context, services) =>
    {
        ...
        services.AddDbContext<GenShinBotContext>(builder => builder.UseSqlite(configuration.GetConnectionString("DbConn")));
        ...
        {
            var dbContext = services.GetRequiredService<GenShinBotContext>();
